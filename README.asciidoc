...
.Running crab
****
In the 'analysis/2ndLevel/submitJobWithCrab3' folder, you'll find the scripts +createAndSubmit[Data][MC]+. These script read a txt file with the sample to use {example}.

[Data] dataset_DASformat processed_events files_per_job GlobalTag
i.e. /SinglePhoton/Run2015D-PromptReco-v4/MINIAOD -1 300 74X_dataRun2_Prompt_v2
[MC] dataset_DASformat processed_events cross_section ptHatMin ptHatMax files_per_job GlobalTag
i.e. /GJet_Pt-15To6000_TuneCUETP8M1-Flat_13TeV_pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM 1 1 0 10000 10 74X_mcRun2_asymptotic_v2
