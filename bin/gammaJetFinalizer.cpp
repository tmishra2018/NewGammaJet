...
void GammaJetFinalizer::runAnalysis() {
        ...
        if (mIsMC) {
                ...
                static std::string puMC30 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();    
                ...
                static std::string puMC50 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();
                ...
                static std::string puMC75 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();   
                ...
                static std::string puMC90 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();  
                ...
                static std::string puMC120 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();
                ...
                static std::string puMC165 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();   
		...
		static std::string puMC200 = TString::Format("%s/computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();//computed_mc_files_2017_MC_pu_truth_100bins.root", puPrefix.c_str()).Data();   
