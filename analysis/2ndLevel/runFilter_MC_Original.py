...
process.source = cms.Source (
    "PoolSource", 
    fileNames = cms.untracked.vstring('file:/cmshome/fpreiato/GammaJet/CMSSW_7_3_2/test/26D84431-6473-E411-ADC6-00266CFFA6F8.root')
#    fileNames = cms.untracked.vstring('file:/cmshome/fpreiato/GammaJet/CMSSW_7_3_2/src/JetMETCorrections/GammaJetFilter/config/lists.txt')
    )
