...
process.GlobalTag.globaltag = cms.string("MCRUN2_74_V9") #run with crab
...
fileName = cms.string("GJet_Pt-15To6000_TuneCUETP8M1-Flat_13TeV_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v3__MINIAODSIM.root") # run with crab
)
