...
process.source = cms.Source("PoolSource",
    ...
    'file:/cmshome/fpreiato/GammaJet/CMSSW_7_4_5/src/JetMETCorrections/GammaJetFilter/analysis/tuples/SinglePhoton_file_1.root' # MiniAOD
#    THISINPUTFILE
...
process.TFileService = cms.Service("TFileService",
     ...
     fileName = cms.string("SinglePhoton__Run2015D-PromptReco-v4__MINIAOD.root")
     )
