...
config.General.workArea = 'Output_Run2//SinglePhoton_GoldenJson_ResClosure_20150807_1504/workdir'
config.General.requestName = 'SinglePhoton__Run2015B-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_GoldenJson_ResClosure_20150807_1504/cfg/SinglePhoton_cmssw.py'
