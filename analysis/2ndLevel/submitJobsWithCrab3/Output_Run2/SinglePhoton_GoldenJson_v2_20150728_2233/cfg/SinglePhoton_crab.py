...
config.General.workArea = 'Output_Run2//SinglePhoton_GoldenJson_v2_20150728_2233/workdir'
config.General.requestName = 'SinglePhoton__Run2015B-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_GoldenJson_v2_20150728_2233/cfg/SinglePhoton_cmssw.py'
