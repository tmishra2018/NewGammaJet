...
config.General.workArea = 'Output_Run2//SinglePhoton_25ns_DCSOnly_12Oct_20151015_1552/workdir'
config.General.requestName = 'SinglePhoton__Run2015D-PromptReco-v4__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_25ns_DCSOnly_12Oct_20151015_1552/cfg/SinglePhoton_cmssw.py'
...
config.Data.lumiMask = '/cmshome/fpreiato/GammaJet/CMSSW_7_4_12_patch4/src/JetMETCorrections/GammaJetFilter/json/json_DCSONLY.txt'
