...
config.General.workArea = 'Output_Run2/SinglePhoton_Run2015_20150716_1651/workdir'
config.General.requestName = 'SinglePhoton__Run2015B-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2/SinglePhoton_Run2015_20150716_1651/cfg/SinglePhoton_cmssw.py'
...
config.Data.lumiMask = '/cmshome/fpreiato/GammaJet/CMSSW_7_4_5/src/JetMETCorrections/GammaJetFilter/json/lumiSummary_15_07_2015_JetHT.txt'
