...
config.General.workArea = 'Output_Run2//SinglePhoton_Run254833_v4_20150826_1354/workdir'
config.General.requestName = 'SinglePhoton__Run2015C-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_Run254833_v4_20150826_1354/cfg/SinglePhoton_cmssw.py'
