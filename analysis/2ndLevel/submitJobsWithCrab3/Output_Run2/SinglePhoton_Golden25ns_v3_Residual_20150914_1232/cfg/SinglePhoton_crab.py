...
config.General.workArea = 'Output_Run2//SinglePhoton_Golden25ns_v3_Residual_20150914_1232/workdir'
config.General.requestName = 'SinglePhoton__Run2015C-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_Golden25ns_v3_Residual_20150914_1232/cfg/SinglePhoton_cmssw.py'
