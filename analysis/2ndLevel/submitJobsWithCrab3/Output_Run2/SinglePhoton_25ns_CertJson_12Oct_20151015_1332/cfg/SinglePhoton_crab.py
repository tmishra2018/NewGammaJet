...
config.General.workArea = 'Output_Run2//SinglePhoton_25ns_CertJson_12Oct_20151015_1332/workdir'
config.General.requestName = 'SinglePhoton__Run2015D-PromptReco-v4__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_25ns_CertJson_12Oct_20151015_1332/cfg/SinglePhoton_cmssw.py'
