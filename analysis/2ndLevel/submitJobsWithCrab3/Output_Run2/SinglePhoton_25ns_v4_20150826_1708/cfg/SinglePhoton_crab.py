...
config.General.workArea = 'Output_Run2//SinglePhoton_25ns_v4_20150826_1708/workdir'
config.General.requestName = 'SinglePhoton__Run2015C-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_25ns_v4_20150826_1708/cfg/SinglePhoton_cmssw.py'
...
config.Data.lumiMask = '/cmshome/fpreiato/GammaJet/CMSSW_7_4_5/src/JetMETCorrections/GammaJetFilter/json/json_25ns.json'
