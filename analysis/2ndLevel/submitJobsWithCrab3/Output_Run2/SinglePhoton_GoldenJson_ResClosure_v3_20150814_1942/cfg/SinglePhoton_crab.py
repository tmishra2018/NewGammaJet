...
config.General.workArea = 'Output_Run2//SinglePhoton_GoldenJson_ResClosure_v3_20150814_1942/workdir'
config.General.requestName = 'SinglePhoton__Run2015B-PromptReco-v1__MINIAOD'
config.section_('JobType')
config.JobType.psetName = 'Output_Run2//SinglePhoton_GoldenJson_ResClosure_v3_20150814_1942/cfg/SinglePhoton_cmssw.py'
