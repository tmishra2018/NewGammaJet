...
#    'file:miniAOD-prod_PAT.root' # MiniAOD
    'file:Express_AOD_1.root' # AOD

#      THISINPUTFILE # to run on crab
      )
    )
...
if runOnAOD:
  process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
      ...
      fileName = cms.untracked.string('Express_miniAOD_PAT.root'),
...
#     fileName = cms.string(THISROOTFILE) # run on crab
     fileName = cms.string("output_Data.root") # run in local
     )
