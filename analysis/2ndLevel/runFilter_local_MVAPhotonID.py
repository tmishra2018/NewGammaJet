...
#process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(1000)) # 1000 events
...
#    'file:Express_AOD_1.root' # AOD
   'file:../tuples/Data/SinglePhoton_file_1.root'  #Express_miniAOD.root' # miniAOD
#      THISINPUTFILE
      )
    )
...
#process.p +=process.photonIDValueMapProducer  # federico -> add Cut Based Photon ID
process.p +=process.egmPhotonIDSequence  # federico -> add MVA Photon ID
