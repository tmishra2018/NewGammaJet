...
samples = {
    'A' : 'Run2018A-12Nov2019_UL2018-v2',
    'B' : 'Run2018B-12Nov2019_UL2018-v2',
    'C' : 'Run2018C-12Nov2019_UL2018-v2',
    'D' : 'Run2018D-12Nov2019_UL2018-v4',
...
merged_runs = ["AB", "CD", "ABCD"]

lumis_per_pb = {
    'Run2018A-12Nov2019_UL2018-v2' : 14026.724849742,
    'Run2018B-12Nov2019_UL2018-v2' : 7060.617355256,
    'Run2018C-12Nov2019_UL2018-v2' : 6894.770971269,
    'Run2018D-12Nov2019_UL2018-v4' : 31834.115904612,
}
...
Step1_outputs_crab_dir = "/afs/cern.ch/work/t/trmishra/JEC-task/CMSSW_10_6_3/src/CMSDIJET/DijetRootTreeMaker/prod/crab/CERN_crab/"
Step2_outputs_base_dir = "/afs/cern.ch/work/t/trmishra/JEC-task/CMSSW_8_0_25/src/JetMETCorrections/GammaJetFilter/lists_2018UL_testing/"
Step3_outputs_base_dir = "/afs/cern.ch/work/t/trmishra/JEC-task/CMSSW_8_0_25/src/JetMETCorrections/GammaJetFilter/2018UL_Step3/"
...
def merge_files_from_step2(run, JERC, cleaning=True):
    ...
    output_dir = "/afs/cern.ch/work/t/trmishra/JEC-task/CMSSW_8_0_25/src/JetMETCorrections/GammaJetFilter/2018UL_Step3/"+JERC+'/'
...
def make_pileup_MC(JERC):
    run = "MC"
    print_log_started_step(run, JERC, 'make pileup')
    files_list = "files_PUreweight_2018UL_{}_{}".format(run, JERC)
    cmds = []
    cmds.append('cd {}'.format(Step3_PU_dir))
...
def Produce_Combination_File_and_plots(run,JERC):
    ...
    os.system("cd {} ; ln -sf computed_mc_files_PUreweight_2018UL_MC_{}_pu_truth_100bins.root computed_mc_files_2018UL_MC_for_{}_{}_pu_truth_100bins.root".format(
        Step3_PU_dir,
        JERC,
        run,
        JERC,
